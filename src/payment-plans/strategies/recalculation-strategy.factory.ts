...
export class RecalculationStrategyFactory {
  private readonly reduceInstallment = new ReduceInstallmentRecalculationStrategy();

  private readonly strategies: ReadonlyMap<AmortizationMode, InstallmentRecalculationStrategy> = new Map<
    AmortizationMode,
  ...
  getFor(mode: AmortizationMode | null | undefined): InstallmentRecalculationStrategy {
